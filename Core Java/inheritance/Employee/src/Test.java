...
class Test {
	...
	public static void main(String[] args) {
		Employee e1= new Employee(101,"vikram",4000);
		e1.display();
		
		System.out.println();
		HR h1 = new HR(102,"virat",34000,800);
        h1.display();
		System .out.println();
	    SalesManager s1 = new SalesManager(103,"sachin",5965,67,600);
	    s1.display();
	    System.out.println();
	    Admin a1 = new Admin(104,"dhoni",4444,900);
	    a1.display();
	    System.out.println("Total Employees: " + Employee.getEmpcount());
	}
